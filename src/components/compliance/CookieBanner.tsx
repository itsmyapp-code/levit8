  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <div className="glass p-6 rounded-2xl neon-border border-electric-cyan/20">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button 
                ...
                className="px-4 py-2 rounded-lg bg-electric-cyan text-deep-space-purple font-bold hover:brightness-110 transition-all text-sm"
              >
                Accept All
              </button>
            </div>
